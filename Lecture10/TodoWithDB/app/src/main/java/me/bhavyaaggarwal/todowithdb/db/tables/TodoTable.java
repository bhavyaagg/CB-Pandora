package me.bhavyaaggarwal.todowithdb.db.tables;
...
import static me.bhavyaaggarwal.todowithdb.db.Consts.*;
...
public class TodoTable {
    ...
    public static final String CMD_CREATE_TABLE = CMD_CREATE_TABLE_INE + TABLE_NAME
            + LBR
